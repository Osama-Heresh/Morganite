...
export const EntityGraphPage: React.FC = () => {
  ...
  const nodes = [
    ...
    },
    {
      ...
      category: 'Founder, Owner & General Manager',
      color: 'bg-[#8C5835] text-white border-[#8C5835]',
      detailsEn: 'Founder, Owner & General Manager of Morganite. Secretary of the 6th Board (July 2025) of JSSEF under Ministry of Agriculture.',
      detailsAr: 'مؤسس ومالك والمدير العام لمورجانيت. أمين سر مجلس الإدارة السادس (تموز 2025) في الجمعية الأردنية للتقييم الحسي للأغذية.',
